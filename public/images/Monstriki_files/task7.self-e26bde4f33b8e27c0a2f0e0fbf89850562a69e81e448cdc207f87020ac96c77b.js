var Picture7 = React.createClass({
  displayName: "Picture7",
...
var Task7 = React.createClass({
  ...
  render: function () {
    ...
    for (i = 1; i <= number_of_pics; i++) {
      ...
      var the_pic = React.createElement(Picture7, { classSizePics: size_pics, task_pic: task_pic_i, toAnswer: this.toAnswer, answer: this.state.answer, item: i, key: i });
      pics.push(the_pic);
    }

    var answer_input = React.createElement("input", { type: "text", className: "", placeholder: "Пиши здесь", ref: "answer", onChange: this.toAnswer });
    ...
    content = React.createElement(
      ...
      React.createElement(
        "div",
        { className: "content-task-type", id: "type_task7" },
        React.createElement(
          "div",
          { className: "wrap-all-pics" },
          pics
        ),
        React.createElement(
          "div",
          { className: "wrap-answer-input" },
          answer_input
        )
      )
    );
