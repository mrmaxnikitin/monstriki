var Picture1 = React.createClass({
...
var Task1 = React.createClass({
  ...
  render: function () {
    ...
    for (i = 1; i <= number_of_pics; i++) {
      ...
      var the_pic = React.createElement(Picture1, { classSizePics: size_pics, task_pic: task_pic_i, toAnswer: this.toAnswer, answer: this.state.answer, item: i, key: i });
      pics.push(the_pic);
    }
