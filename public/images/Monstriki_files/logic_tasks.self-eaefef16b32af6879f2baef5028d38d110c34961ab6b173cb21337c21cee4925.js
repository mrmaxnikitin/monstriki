var LogicTasks = React.createClass({
  displayName: 'LogicTasks',
  ...
  render: function () {
    ...
    if (this.props.quest) {
      stage_tasks = this.state.tasks.map((function (task, i) {
        return React.createElement(QuestTask, {
          key: task.id + 100,
          task: task,
    ...
    var tasks = this.state.tasks.map((function (task) {
      switch (task.task_type) {
        case 1:
          ...
          return React.createElement(Task1, {
            key: task.id,
            task: task,
          ...
          break;
        case 2:
          return React.createElement(Task2, {
            key: task.id,
            task: task,
          ...
          break;
        case 3:
          return React.createElement(Task3, {
            key: task.id,
            task: task,
            acceptAnswer: this.acceptAnswer,
            status_current_task: this.state.status_current_task,
          ...
          break;
        case 4:
          return React.createElement(Task4, {
            key: task.id,
            task: task,
            acceptAnswer: this.acceptAnswer,
            status_current_task: this.state.status_current_task,
          ...
          break;
        case 5:
          return React.createElement(Task5, {
            key: task.id,
            task: task,
            acceptAnswer: this.acceptAnswer,
            status_current_task: this.state.status_current_task,
          ...
          break;
        case 6:
          return React.createElement(Task6, {
            key: task.id,
            task: task,
            acceptAnswer: this.acceptAnswer,
            status_current_task: this.state.status_current_task,
          ...
          break;
        case 7:
          return React.createElement(Task7, {
            key: task.id,
            task: task,
            acceptAnswer: this.acceptAnswer,
            status_current_task: this.state.status_current_task,
          ...
          break;
        case 8:
          return React.createElement(Task8, {
            key: task.id,
            task: task,
            acceptAnswer: this.acceptAnswer,
            status_current_task: this.state.status_current_task,
          ...
          break;
        case 9:
          return React.createElement(Task9, {
            key: task.id,
            task: task,
            acceptAnswer: this.acceptAnswer,
            status_current_task: this.state.status_current_task,
    ...
    var profile = React.createElement(Profile, {
      key: 1,
      score: score
    });
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'col col-task-main col-67proc ml-2proc' },
        content_task
      )
    );
  }
